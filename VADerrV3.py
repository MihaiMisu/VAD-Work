...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 24 13:53:41 2017
...
#                    print(myStartLabels[j], '    ', timitLabels[i][0])
                    break
                elif myEndLabels[j] < timitLabels[i][0] and myStartLabels[j+1] > timitLabels[i][1]:
                    nrEs += timitLabels[i][1] - timitLabels[i][0]
#                    print(timitLabels[i][1], '    ', timitLabels[i][0])
                if j == len(myStartLabels)-2:
                    if timitLabels[i][0] < myStartLabels[j+1] and myStartLabels[j+1] < timitLabels[i][1]:
                        nrEs += myStartLabels[j+1] - timitLabels[i][0]
#                        print(myStartLabels[j+1], '    ', timitLabels[i][0])
                    if myEndLabels[j+1] < timitLabels[i][0]:
                        nrEs = timitLabels[i][1] - timitLabels[i][0]
#                        print(timitLabels[i][1], '    ', timitLabels[i][0])
